...
import { Modal, Table, TreeSelect, Divider, InputNumber, DatePicker, Dropdown, Menu, Row, Col, Tag, Popconfirm, Badge, Button, Card, Form, Input, Select, Icon } from 'antd';
                    ...
                    <div className={styles.tableList}>
                        ...
                        <div className={styles.tableListOperator}>
                            <span className={styles.submitButtons}>
                                ...
                                >新增用户</Button>
                                <Button style={{ float:'right',marginRight: 18,marginLeft: 8}} onClick={this.handleFormReset}>
                                    重置</Button>
                                <Button style={{ float:'right',marginRight: 8 }} type="primary" onClick={this.handleSearch}>
                                查询</Button>
                            </span>
                        </div>
                    </div>
                        ...
                        <Row>
                            <FormItem {...formItemLayout} label="用户名:" hasFeedback>
                                {getFieldDecorator('userName', {
                                    ...
                                    <Input placeholder="请输入用户名" disabled={this.state.type == "edit" ? true : false} />
                                )}
                            </FormItem>
                        </Row>
                        <Row>
